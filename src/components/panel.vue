<template>
  <div class="panel">
    <div v-if="showHeader" class="panel-header">
      <el-icon v-if="showIcon" class="title-icon"><component :is="icon" /></el-icon>
...
.panel > *:nth-child(2) {
  min-height: calc(var(--panel-body-height) - var(--panel-padding) * 2);
  max-height: calc(var(--panel-body-height) - var(--panel-padding) * 2);
  overflow: scroll;
}
</style>
